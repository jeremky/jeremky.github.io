...
```ini {filename="flame.env"}
TZ=Europe/Paris
PASSWORD_FILE=./.password
```

> [!IMPORTANT]
> Vous remarquerez la présence de l'entrée `secrets`. Vous devez créer un fichier `.password` et y saisir un mot de passe. Via cette méthode, votre mot de passe ne sera pas visible dans les variables d'environnement du conteneur
...
```nginx {filename="flame.subdomain.conf"}
## Version 2024/07/16
...
![exemple1](exemple1.webp)

![exemple2](exemple2.webp)

![exemple3](exemple3.webp)
