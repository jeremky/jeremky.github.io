...
cover: "/img/posts/freshrss-un-agregateur-de-flux-rss/cover.webp"
tags:
  - docker
  - podman
categories:
...
{{< image src="/img/posts/freshrss-un-agregateur-de-flux-rss/screenshot.webp" style="border-radius: 8px;" >}}
...
{{< image src="/img/posts/freshrss-un-agregateur-de-flux-rss/init.webp" style="border-radius: 8px;" >}}

Il vous sera demandé de sélectionner la base à utiliser. Comme vu plus haut, nous allons faire simple et choisir SQLite : 

{{< image src="/img/posts/freshrss-un-agregateur-de-flux-rss/bdd.webp" style="border-radius: 8px;" >}}

Ensuite, saisissez votre nom d'utilisateur et votre mot de passe : 

{{< image src="/img/posts/freshrss-un-agregateur-de-flux-rss/user.webp" style="border-radius: 8px;" >}}

Une fois les différentes étapes effectuées, FreshRSS va vous renvoyer vers la page d'accueil :

{{< image src="/img/posts/freshrss-un-agregateur-de-flux-rss/accueil.webp" style="border-radius: 8px;" >}}
