...
cover: /img/posts/authelia-serveur-dauthentification-open-source/cover.webp
tags:
  - admin
  - docker
  - podman
...
{{< image src="/img/posts/authelia-serveur-dauthentification-open-source/login.webp" style="border-radius: 8px;" >}}
