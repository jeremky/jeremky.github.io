...
cover: /img/posts/transmission-un-client-torrent-web/cover.webp
tags:
  - fichiers
  - docker
  - podman
...
{{< image src="/img/posts/transmission-un-client-torrent-web/addtorrent.webp" style="border-radius: 8px;" >}}

Une fois votre torrent ajouté, voici le rendu de l'interface :

{{< image src="/img/posts/transmission-un-client-torrent-web/download.webp" style="border-radius: 8px;" >}}
