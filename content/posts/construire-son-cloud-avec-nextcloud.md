...
cover: /img/posts/construire-son-cloud-avec-nextcloud/cover.webp
tags:
  - fichiers
  - docker
  - podman
...
{{< image src="/img/posts/construire-son-cloud-avec-nextcloud/sqlselect.webp" style="border-radius: 8px;" >}}
...
{{< image src="/img/posts/construire-son-cloud-avec-nextcloud/sqlconfig.webp" style="border-radius: 8px;" >}}
...
{{< image src="/img/posts/construire-son-cloud-avec-nextcloud/appsreco.webp" style="border-radius: 8px;" >}}

Vous devriez enfin vous retrouver sur la page d’accueil :

{{< image src="/img/posts/construire-son-cloud-avec-nextcloud/wizard.webp" style="border-radius: 8px;" >}}
***
{{< image src="/img/posts/construire-son-cloud-avec-nextcloud/dashboard.webp" style="border-radius: 8px;" >}}
