...
cover: /img/posts/pairdrop-transferez-des-fichiers-facilement/cover.webp
tags:
  - fichiers
  - docker
  - podman
...
{{< image src="/img/posts/pairdrop-transferez-des-fichiers-facilement/associate.webp" style="border-radius: 8px;" >}}
...
{{< image src="/img/posts/pairdrop-transferez-des-fichiers-facilement/file.webp" style="border-radius: 8px;" >}}

Pour du texte, c’est via un clic droit (ou une pression longue sur mobile).

{{< image src="/img/posts/pairdrop-transferez-des-fichiers-facilement/text.webp" style="border-radius: 8px;" >}}
...
{{< image src="/img/posts/pairdrop-transferez-des-fichiers-facilement/auto.webp" style="border-radius: 8px;" >}}
